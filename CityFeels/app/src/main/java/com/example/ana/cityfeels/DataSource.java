...
public class DataSource
{
												   ...
												   DataLayer layer) throws IOException
	{
		...
		try
		{
			...
			pontoInteresse = new PontoInteresseBasic(pi.id, pi.posicao, pi.informacao,
													 pi.orientacao);
	...
	public static PontoInteresseLocal toLocal(PontoInteresseBasic pontoInteresseBasic) throws IOException, JSONException
	{
		...
		for(com.example.ana.cityfeels.sia.PontoInteresse ponto : SIA.getCloseByPontoInteresse(
				pontoInteresseBasic.getPosicao(), MAX_METERS_BETWEEN_POI))
													...
													String infDetalhada) throws IOException, JSONException
	{
		...
		for(com.example.ana.cityfeels.sia.PontoInteresse ponto : SIA.getCloseByPontoInteresse(
				pontoInteresseLocal.getPosicao(), MAX_METERS_BETWEEN_POI))
			arredoresList.add(PontoInteresseBasic.fromPontoInteresse(ponto));
